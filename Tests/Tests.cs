...
namespace Tests
{
    ...
    public class Tests
    {
        ...
        public void TestISimpleUser()
        {
            ...
            Console.WriteLine(user.Id); //The Id was generated by incrementing a redis counter.
            Console.WriteLine(user.Name); //Nada. The user's name is empty.

            user.Name = "Jason Punyon"; //That wrote to redis...(for realz! go check I'll wait).
            user.AwesomenessLevel = 100; //That wrote to redis too.
